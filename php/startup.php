...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-topleft w3-text-black w100-1" style="padding:5%; margin-left: 10%; margin-top: 7em; width: 40%; max-height: 20rem;">
    <h2>JUST coding it</h2>
    <div style="width: 40px; height:10px; background-color: black;"></div>
    <span class="w3-large" style="margin-top: 1em">Stop wasting valuable time with projects that just isn't you.</span>
  ...
  <div class="w3-display-middle" style="margin-left: 15%; margin-top: 22%;">
      <img src="../img/main.83684950.png" alt="" style=" width: 100%;">
      <img src="../img/components.ea89c574.png" alt="" style=" margin-top: -110%; width: 55%;">
...
<div class="w3-container" style="background-color: gray; padding:10em 1em; height: 29rem; overflow:hidden;" id="about">
  <div class="w3-row">

<!-- <video id="video" autoplay loop muted playsinline poster="../img/back.png">
    <source src="../video/home-loop.c0fbd200.webm" type="video/webm">
    <source src="../video/home-loop.3d6cde55.mp4" type="video/mp4">
</video> -->
<!-- <video loop autoplay controls="false" id="video" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0" >
      <source src="../video/mom.mp4" type="video/mp4">
</video> -->
        
        <div class="w3-col w10" style="width:25%; "><p>25%</p></div>
        <div class="w3-col w80" style="width:60%">
            <div class="w3-row" style="padding:0 0.3em">
                <div class="w3-col w100" style="width:40%;"><h3 style="padding:0;">WE MAKE <br> THE FUTURE</h3></div>
                <div class="w3-col w100" style="width:60%; max-height: 10rem;"><p style="padding:0;">Create something unique and exciting. Have fun as you interact with the digital world, and take the next step towards becoming an inventor.  </p></div>
            </div>
        </div>
        <div class="w3-col w10" style="width:15%"><p>15%</p></div>
...
<!-- Section -->
<!-- <div class="w3-container" style="padding:5em 20em" id="about">
    <div class="w3-row" style="padding: 0 3em">
        <div class="w3-col" style="width:40%"><p>40%</p></div>
        
        <div class="w3-col" style="width:60%"><p>40%</p></div>
    </div>
</div> -->
